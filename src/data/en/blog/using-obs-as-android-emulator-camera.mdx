...
draft: false
summary: 'Learn how to output a video file to the camera input of an Android emulator. Create a virtual camera using OBS Studio and enable it in the Android emulator.'
authors: ['default']
---
