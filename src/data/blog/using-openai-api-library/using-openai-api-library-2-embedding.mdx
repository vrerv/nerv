---
title: 'OpenAI Python Library 사용하기 2 - Token, Embedding'
date: '2023-08-17'
...
임베딩은 부동 소수점 숫자의 벡터(목록)이다. 두 벡터 사이의 거리는 관련성을 나타낸다.
...
따라서, 실제 임베딩을 할때에는 최대 길이를 생각해야 하고, 만약 입력이 최대값을 초과한다면, 다음 방법등으로 처리해야 한다.
